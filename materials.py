...
Defines every material used by the core model from the parameter values in
``config.py``: TRISO kernel and coating layers, graphite matrix and reflector,
helium coolant, B4C absorbers, Incoloy 800H structural components and the BeO
reflector.
